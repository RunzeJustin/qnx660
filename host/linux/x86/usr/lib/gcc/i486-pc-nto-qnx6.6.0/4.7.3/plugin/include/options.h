...
enum opt_code
{
  ...
  OPT_fstrict_enums = 852,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 853,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 854, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 855,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 856,                    /* -fsyntax-only */
  OPT_ftabstop_ = 857,                       /* -ftabstop= */
  /* OPT_ftarget_help = 858, */              /* -ftarget-help */
  OPT_ftarget_ = 859,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 860, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 861,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 862,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 863, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 864,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 865,             /* -fthreadsafe-statics */
  OPT_ftime_report = 866,                    /* -ftime-report */
  OPT_ftls_model_ = 867,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 868,               /* -ftoplevel-reorder */
  OPT_ftracer = 869,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 870,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 871,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 872,                  /* -ftrapping-math */
  OPT_ftrapv = 873,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 874,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 875,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 876,                       /* -ftree-ccp */
  OPT_ftree_ch = 877,                        /* -ftree-ch */
  OPT_ftree_copy_prop = 878,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 879,                /* -ftree-copyrename */
  OPT_ftree_cselim = 880,                    /* -ftree-cselim */
  OPT_ftree_dce = 881,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 882,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 883,                       /* -ftree-dse */
  OPT_ftree_forwprop = 884,                  /* -ftree-forwprop */
  OPT_ftree_fre = 885,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 886,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 887,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 888,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 889,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 890,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 891,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 892, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 893,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 894,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 895,        /* -ftree-parallelize-loops= */
  ...
  OPT_m128bit_long_double = 990,             /* -m128bit-long-double */
  OPT_m32 = 991,                             /* -m32 */
  OPT_m3dnow = 992,                          /* -m3dnow */
  OPT_m3dnowa = 993,                         /* -m3dnowa */
  OPT_m64 = 994,                             /* -m64 */
  OPT_m80387 = 995,                          /* -m80387 */
  OPT_m8bit_idiv = 996,                      /* -m8bit-idiv */
  OPT_m96bit_long_double = 997,              /* -m96bit-long-double */
  OPT_mabi_ = 998,                           /* -mabi= */
  OPT_mabm = 999,                            /* -mabm */
  OPT_maccumulate_outgoing_args = 1000,      /* -maccumulate-outgoing-args */
  OPT_maes = 1001,                           /* -maes */
  OPT_malign_double = 1002,                  /* -malign-double */
  OPT_malign_functions_ = 1003,              /* -malign-functions= */
  OPT_malign_jumps_ = 1004,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1005,                  /* -malign-loops= */
  OPT_malign_stringops = 1006,               /* -malign-stringops */
  OPT_march_ = 1007,                         /* -march= */
  OPT_masm_ = 1008,                          /* -masm= */
  OPT_mavx = 1009,                           /* -mavx */
  OPT_mavx2 = 1010,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1011,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1012,  /* -mavx256-split-unaligned-store */
  OPT_mbmi = 1013,                           /* -mbmi */
  OPT_mbmi2 = 1014,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1015,                  /* -mbranch-cost= */
  OPT_mcld = 1016,                           /* -mcld */
  OPT_mcmodel_ = 1017,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1018, */                    /* -mcpu= */
  OPT_mcrc32 = 1019,                         /* -mcrc32 */
  OPT_mcx16 = 1020,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1021,            /* -mdispatch-scheduler */
  OPT_mf16c = 1022,                          /* -mf16c */
  OPT_mfancy_math_387 = 1023,                /* -mfancy-math-387 */
  OPT_mfentry = 1024,                        /* -mfentry */
  OPT_mfma = 1025,                           /* -mfma */
  OPT_mfma4 = 1026,                          /* -mfma4 */
  OPT_mforce_drap = 1027,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1028,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1029,                       /* -mfpmath= */
  OPT_mfsgsbase = 1030,                      /* -mfsgsbase */
  ...
  OPT_rpath_link = 1123,                     /* -rpath-link */
  OPT_rpath_link_ = 1124,                    /* -rpath-link= */
  OPT_rpath_ = 1125,                         /* -rpath= */
  OPT_s = 1126,                              /* -s */
