...
#define QNX6FS_EMODE_MASK		0x0001		/* Mask of valid emode bits */
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/services/blk/fs/qnx6/public/sys/fs_qnx6.h $ $Rev: 724903 $")
#endif
