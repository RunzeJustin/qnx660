...
#define HIDD_DATA_CONSTANT				0x00000001  /* DATA                */
...
#define HIDD_HAS_NULL_STATE( flags )		(flags & HIDD_DATA_NULL_STATE) 			? 1 : 0
#define HIDD_HAS_NO_NULL_STATE( flags )		(flags & HIDD_DATA_NULL_STATE) 			? 0 : 1
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/lib/hiddi/public/sys/hiddi.h $ $Rev: 704918 $")
#endif
