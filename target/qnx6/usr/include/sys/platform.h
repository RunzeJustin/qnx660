...
#if defined(_QNX_SOURCE) || (_XOPEN_SOURCE+0 >= 700) || (_POSIX_C_SOURCE+0 >= 200809) || (defined(__EXT) && !defined(_POSIX_SOURCE) && (_POSIX_C_SOURCE+0 <= 0) && !defined(_XOPEN_SOURCE))
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/lib/c/public/sys/platform.h $ $Rev: 735308 $")
#endif
