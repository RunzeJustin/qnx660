...
/* Resmgr interface */
#define DEVSET_PTR_CTRL_CODE  0

#define DCMD_SET_PTR_CTRL __DIOT(_DCMD_INPUT, DEVSET_PTR_CTRL_CODE, int)
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/devi/public/sys/dcmd_input.h $ $Rev: 732568 $")
#endif
