...
# error Endian not defined
	...
	#define _NO_RETURN(__fun) void __fun __attribute__((__noreturn__))
 #else
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/lib/c/public/sys/compiler_gnu.h $ $Rev: 735995 $")
#endif
