...
int elf_getbuildid(Elf *elf, unsigned char* buff, size_t bufsize, int *idtype);
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/lib/elf/public/libelf.h $ $Rev: 729704 $")
#endif
