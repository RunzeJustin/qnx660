...
unsigned _smp_cmpxchg(volatile unsigned *__dst, unsigned __cmp, unsigned __new);
...
static __inline unsigned __attribute__((__unused__)) _smp_cmpxchg(volatile unsigned *__dst, unsigned __cmd, unsigned __new) {
...
static __inline unsigned __attribute__((__unused__)) _smp_xchg(volatile unsigned *__dst, unsigned __src) {
	__asm__ __volatile__(
		"xchgl %0,%1"
		:"=r" (__src)
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/lib/c/public/x86/smpxchg.h $ $Rev: 733223 $")
#endif
