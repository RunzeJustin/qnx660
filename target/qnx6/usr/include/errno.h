...
#define EALREADY_OLD    EBUSY              /* Operation already in progress pre-6.6.0 */
#define EALREADY_NEW      237              /* Operation already in progress for POSIX conformance */
#define EALREADY_DYNAMIC  __ealready_value
#ifndef EALREADY
#define	EALREADY	EALREADY_NEW
#endif
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/lib/c/public/errno.h $ $Rev: 735175 $")
#endif
